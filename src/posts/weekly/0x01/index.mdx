...
icon: "mdi:train-car"
desc: "为了记录自己的精神状态，我决定开始写周报。"
og:
  src: "//raw.githubusercontent.com/OverflowCat/blog/9345fbcaefb92ee01b124c62fcf3e7d5c8477297/public/weekly/0x01/css-3.png"
  aspect: 1768:998
math: mathjax
...
import Bilibili from "@/components/social/Bilibili/Bilibili";
...
<Bilibili client:only="react" bv="BV1PV411T7yG" thumbnail="https://raw.githubusercontent.com/OverflowCat/blog/test_a/imgs/weekly/0x01/少女周末旅行.webp" />
