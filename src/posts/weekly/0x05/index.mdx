...
简正转换是通过 opencc-js 实现，因为 opencc 在我:j[这块]{m="tsəʔ⁴ kʰuɛ⁵³，这里"}因为 [C++ 代码出纰漏](https://github.com/BYVoid/OpenCC/issues/883)的原因装不上。
...
一部观感比较惊艳的电影——至少是视觉上。风格被评价是中式梦核。动漫元素的穿插给人一种魔幻现实的感觉，即便我:j[自敢]{m="自己"}不是很欢喜。讲述了一个一群人一次次尝试改变未来而又徒劳无功的故事。作者对这个结局的回应是主角天真地喊「一定不要变坏啊！」，我觉得还是换一下形式比较好。不过存在主义的内核其实不一定要对精神困境给出答案。

一个缺点是设定，无非是一个看上去更黑暗一点的地球，犯不着弄得陌生。K星的虚构设定并没有起到什么作用，加重了认知负担。譬如，既然本身已经这杠子:j[韶]{m="疯"}了，就算说那种五颜六色的蛤蟆是地球上的生物也是不得问题的。
