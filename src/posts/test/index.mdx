...
import UaIcon from "./_UaIcons.astro";
...
<input type="checkbox" id="show-borders" name="borders" />
<label for="borders">显示边框（调试用）</label>
...
<Kanbun text={`
蜜雪氷城(トロント)ノ裏(うち)ニハ、
温(メ)レ茶ヲ[二]盼(まつ)暖カ春ヲ[一]。

不[レ]知ラ[三]臨[リンアン]邑(くに)ノ陌(みち)ニ、
白兔叩(たた)[二]ク誰ノ門(もん)ヲ[一]。
`} betagumi />
...
孤之有ルハ[二]孔明(こうめい)[一]，猶ホ‹ごと›«キ»[二]魚之有ルガ[一レ]水也。
...
import Visitor from "@/posts/harmony/cangjie/_visitor.md";
...
![前端之猫](https://remnote-user-data.s3.amazonaws.com/OXQJP0v52Qas6rfeUfDrOH1DFPqfCdZqmWt7QQ7C4y35BQGKlU0q3TJYrODPsQPCaVXJwZU4wED0bGXEsCwEW2lsdSLKtrk7tUwfbSd9tqwm55CaLCMqNn2ryIh8oqOf.png "前端之猫在室外")
...
import Uno from "@/components/Uno.astro";
