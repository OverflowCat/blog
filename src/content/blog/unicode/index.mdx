...
<Img src="https://tonsky.me/blog/unicode/nerd_font@2x.png"
  ...
  zhcap="Isn’t it a beauty? It’s all text!" />
...
他们将会看起来一样（`Å` vs `Å`），它们应该用起来一样，并且就所有意图和目的而言，它们被认为是完全相同的。唯一的区别是字节表示。
...
为什么连 `ﬁ` 这个连字都有它自己的码位？不知道。在一百万个字符中会发生很多事情。
...
3. 混起来后再匹配很难。比如保加利亚文中的俄语名字，反之亦然。为什么不呢？这是互联网，来自各种文化的人都在这里冲浪。
...
[^twitter]: Twitter 错误渲染俄语为保加利亚语——注意 <span lang='bg'>ь</span>、<span lang='bg'>к</span>、<span lang='bg'>з</span> 的字形——译者注

<a href="https://twitter.com/nikitonsky/status/1171115067112398849">
  <Img src="https://tonsky.me/blog/unicode/twitter_locale.jpg" />
</a>

![](./tweet-translated.webp)
...
zhcap="Unicode 标准的 1.0 版本, October 1991 年 10 月"
