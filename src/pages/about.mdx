...
lit. "the gate to a new world",
is a Mandarin slang that describes a brand new experience,
such as learning a new language or crossdressing for the first time.
...
The blog system <Del>will be changed in the near future</Del> <Add>is under construction</Add>,
and comments will be added.
Nevertheless, I believe you should check my [Mastodon](https://mastodon.social/@overflowcat)
account (`@overflowcat@mastodon.social`) in Fediverse if you are not following me.
