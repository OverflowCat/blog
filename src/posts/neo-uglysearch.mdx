...
photo:
  src: https://neo-uglysearch.vercel.app/preview.png
  aspect: 926:383
  alt: 丑搜 v3
licence: "CcBy"
...
*   **新界面也太酷了8⃣！** [前端之猫](/about)用 Next.js 以新粗野主义设计风格的前端，名字叫 neo-uglysearch，还有 Telegram 的可爱小黄鸭，简直萌化了我的少女心！用起来也敲丝滑！流畅度 up up！
...
用的 Next.js，初版以 [v0](https://v0.dev/) 写成。因为太麻烦，这次不支持无
JS 了，你可以用 v2 或 v1。不过，[谷歌也不支持](http://news.ycombinator.com/item?id=42747092)了，所以 $丑搜 \approx 谷歌$。
