...
<div class="flex tweet" data-tweet-id="1809085263110365233">
  <p>
    Tweet embed disabled. View the original post:
    <a href="https://twitter.com/i/web/status/1809085263110365233">https://twitter.com/i/web/status/1809085263110365233</a>
  </p>
</div>
...
5. 读数据返回的是 `Promise<ReadableStreamReadResult<R>>`，有 `value` 和 `done`。注意即使 `done` 为 `true`，`value` 可能还是有内容的，不要忘记处理。
